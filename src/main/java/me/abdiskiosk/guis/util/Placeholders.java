...
public class Placeholders {
    ...
    public static Collection<StaticNamedState<?>> of(@NotNull Object o1, @NotNull String name1) {
        return of(State.immutable(o1, name1));
    }

    public static Collection<StaticNamedState<?>> of(@NotNull Object o1, @NotNull String name1,
                                                     @NotNull Object o2, @NotNull String name2) {
        return of(State.immutable(o1, name1), State.immutable(o2, name2));
    }

    public static Collection<StaticNamedState<?>> of(@NotNull Object o1, @NotNull String name1,
                                                     @NotNull Object o2, @NotNull String name2,
                                                     @NotNull Object o3, @NotNull String name3) {
    ...
    public static Collection<StaticNamedState<?>> of(@NotNull Object o1, @NotNull String name1,
                                                     @NotNull Object o2, @NotNull String name2,
                                                     @NotNull Object o3, @NotNull String name3,
                                                     @NotNull Object o4, @NotNull String name4) {
    ...
    public static Collection<StaticNamedState<?>> of(@NotNull Object o1, @NotNull String name1,
                                                     ...
                                                     @NotNull Object o3, @NotNull String name3,
                                                     @NotNull Object o4, @NotNull String name4,
                                                     @NotNull Object o5, @NotNull String name5) {
    ...
    public static Collection<StaticNamedState<?>> of(@NotNull Object o1, @NotNull String name1,
                                                     ...
                                                     @NotNull Object o4, @NotNull String name4,
                                                     @NotNull Object o5, @NotNull String name5,
                                                     @NotNull Object o6, @NotNull String name6) {
